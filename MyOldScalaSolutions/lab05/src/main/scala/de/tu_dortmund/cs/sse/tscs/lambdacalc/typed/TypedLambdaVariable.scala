...
/**
  ...
  */
case class TypedLambdaVariable(val variable : String, typeAnnotation: Option[TypeInformation] = None) extends LambdaVariable(variable) with TypedLambdaExpression {
