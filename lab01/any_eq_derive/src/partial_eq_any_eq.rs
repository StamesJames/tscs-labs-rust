...
pub fn impl_partial_eq_any_eq(ast: &syn::DeriveInput) -> TokenStream {
...
fn make_named_fields(
    fields: &FieldsNamed
) -> (quote::__private::TokenStream, quote::__private::TokenStream, quote::__private::TokenStream) {
...
fn make_unnamed_fields(
    ...
    (fields_unnamed_left, fields_unnamed_right, fields_unnamed_comps)
}
